...
qa_is_path_variable() {
  case "$1" in
    HOME|USERPROFILE|TEMP|TMP|TMPDIR|LOCAL_EXTENSION_REPO|GOOGLE_APPLICATION_CREDENTIALS|BQ_TEST_SA_KEY_PATH|PYTHON_HTTP_SERVER_DIR|GOLDEN_TABLES_PATH|DELTA_KERNEL_TESTS_PATH|DAT_PATH)
      return 0
      ;;
    *)
      return 1
